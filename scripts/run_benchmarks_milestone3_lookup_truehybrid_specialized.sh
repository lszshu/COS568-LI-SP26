...
for INDEX in LIPP HybridPGMLIPPDirectLippSpecialized HybridPGMLIPPWriteThroughSpecialized HybridPGMLIPPLookupSpecialized0 HybridPGMLIPPLookupSpecialized6
do
