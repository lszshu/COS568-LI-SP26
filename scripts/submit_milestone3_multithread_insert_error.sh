...
JOB_SCRIPT="$REPO_ROOT/jobs/run_milestone3_multithread_insert_error_array.slurm"
...
echo "Analyze with:"
echo "  $REPO_ROOT/scripts/analyze_milestone3_multithread_insert_error.sh ${JOB_ID} ${THREAD_COUNT}"
