...
echo "Executing dataset=${DATASET}, insert-ratio=${INSERT_RATIO}, index=HybridPGMLIPPIncremental, params=262144,1,0,1,1,6,0,0"
"$BENCHMARK" "$DATA_FILE" "$OPS_FILE" --through --csv --only HybridPGMLIPPIncremental -r 3 \
    --params 262144,1,0,1,1,6,0,0

echo "Executing dataset=${DATASET}, insert-ratio=${INSERT_RATIO}, index=HybridPGMLIPPIncremental, params=262144,1,0,1,1,0,0,0"
"$BENCHMARK" "$DATA_FILE" "$OPS_FILE" --through --csv --only HybridPGMLIPPIncremental -r 3 \
    --params 262144,1,0,1,1,0,0,0
